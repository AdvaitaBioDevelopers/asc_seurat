                   ...
                   fluidRow(
                       ...
                       column(width = 3,
                              ...
                              conditionalPanel (
                                  ...
                                  fileInput( inputId = "upload", label = "Upload 10x chromium data as zip", multiple = F, accept = '.zip' ),
                              ),
                       ),
                   ...
                   fluidRow(
                       column(width = 3,
                              ...
                              conditionalPanel (
                                  ...
                                  div(class = "option-group",
                                  fileInput( inputId = "multi_upload", label = "Upload 10x chromium data as zip", multiple = F, accept = '.zip' ),
                                  # div(class = "option-group",
                                      fileInput("samples_list_integration",
                                                # label = "Read the configuration file containing the samples' information",
                                                label = "Upload metadata information as csv",
                                                accept = c(
                                                    'text/csv',
                   ...
                   conditionalPanel(
                       ...
                       fluidRow(
                           ...
                           conditionalPanel(
                               ...
                               column(3,
                                      div(class = "option-group",
                                          my_withSpinner( uiOutput("find_markers_or_DE_tab2_cluster1_ui") ),
                                          my_withSpinner( uiOutput("find_markers_or_DE_tab2_treat1_ui") ),
                                          my_withSpinner( uiOutput("find_markers_or_DE_tab2_cluster2_ui") ),
